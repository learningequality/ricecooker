...
TEST_CASES = {
    "basic": {
        "files": {"test.txt": "Hello World", "folder/nested.txt": "Nested content"},
        "entrypoint": "folder/nested.txt",
        "expected_md5": "b97246b14853a315903ad31018c03a38",  # Generated by running this file as a script
    },
    "reversed": {
