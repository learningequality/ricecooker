...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["index.html", "css/a.css"], "index.html"),
        (["other.html", "index.html"], "index.html"),
        # then index.html relative to the common root
        (["app/index.html", "app/main.js"], "app/index.html"),
        (["dist/other.html", "dist/index.html"], "dist/index.html"),
        # then any index.html
        (["main.html", "sub/index.html"], "sub/index.html"),
        # a shallower root index wins over a nested one
        (["b/index.html", "index.html"], "index.html"),
        # then the shallowest / shortest-named html file
        (["reader/page2.html", "reader/start.html"], "reader/page2.html"),
        (["b/page.html", "a.html"], "a.html"),
        # no html files at all
        (["a.png", "data.json"], None),
        (["style.css", "script.js"], None),
    ],
)
def test_find_html_entrypoint(names, expected):
    assert find_html_entrypoint(names) == expected
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["a/b/x.html", "a/b/y.css"], "a/b"),
        (["a/b/x.html", "a/c/y.css"], "a"),
        (["a/x.html", "y.css"], ""),
    ],
)
def test_find_common_root(names, expected):
    assert find_common_root(names) == expected
