...
def invalid_document_file():
    ...
    # )
    local_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "testcontent", "generated", "invalid_document.pdf"))
...
def invalid_epub_file():
    ...
    # )
    local_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "testcontent", "generated", "invalid_document.epub"))
