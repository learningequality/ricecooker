...
class WikipediaVideoChef(SushiChef):
    ...
    def construct_channel(self, *args, **kwargs):
        ...
        videos_topic = TopicNode(
            source_id="/wiki/Category:Articles_containing_video_clips",
        ...
        page = download_wikipedia_page(
            "/wiki/Category:Articles_containing_video_clips",
            thumbnail_url,
            "A Is for Atom",
        )
        ...
        video_node = VideoNode(
            ...
            source_id="A_Is_for_Atom_1953.webm",
            files=[video_file],
