#!/usr/bin/env python
"""Sample page-archiving chef: renders a JS/SPA page to an offline HTML5 zip.

The built-in DOWNLOAD stage detects that the source URL serves HTML and renders
it with single-file-cli — no marker or custom pipeline wiring needed. See
README.md / docs/installation.md for the single-file-cli + Chromium prerequisites.
"""
