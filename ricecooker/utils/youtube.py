...
def _get_language_with_alpha2_fallback(language_code):
    ...
    language_obj = languages.getlang(language.to_tag()) or languages.getlang(language.to_alpha3())
    return language_obj
...
def get_language_with_alpha2_fallback(language_code):
    ...
    return _get_language_with_alpha2_fallback(language_code) or _get_language_with_alpha2_fallback(split_code)
