"""Usage: ricecooker uploadchannel [-hvqru] <file_path> [--resume] [--debug] [[OPTIONS] ...]
...
Arguments:
  ...
  --resume         Resume from where rice cooker left off
...
if __name__ == '__main__':
    ...
    uploadchannel(arguments["<file_path>"], domain, verbose=arguments["-v"], update=arguments["-u"], resume=arguments['--resume'], **kwargs)