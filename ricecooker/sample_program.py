...
def _build_tree(node, sourcetree):
    ...
    for child_source_node in sourcetree:
        ...
        if kind == content_kinds.TOPIC:
            ...
            child_node.add_file(YouTubeSubtitleFile("kpCJyQ2usJ4", language="sw"))
            child_node.add_file(YouTubeSubtitleFile("kpCJyQ2usJ4", language="fil"))
            node.add_child(child_node)
